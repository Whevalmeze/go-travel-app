        ...
        <form className="flex bg-white border max-w-[500px] lg:w-[500px] rounded-md gap-1">
            ...
            <div className={slide ==3 ? showCardStyle : slide == 4 ? hideCardStyle : hideCardStyle} >
              ...
              <div className="relative w-full min-w-[200px]">
                ...
                <Link href='/plan-trip/bahamas-trip' ><input type="submit" value="Save" className="bg-primary-blue cursor-pointer rounded px-6 py-2 text-white" onClick={(e)=> {getNextSlide(e); handleSubmit(e)}} /></Link>
            </div>
          </form>
          }
    </main>
