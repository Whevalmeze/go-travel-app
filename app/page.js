    ...
    <main className="flex flex-col items-center tracking-tighter bg-white text-[#676E7E] p-3 w-full rounded-md">
      ...
      <div className="text-black">
        ...
        <form action="GET" className="flex min-w-full rounded-md gap-1">
          ...
          <input type="date" name="checkoutdate" min={date}  className="bg-[#fff] cursor-pointer w-[20%] py-2 px-4 border rounded h-full" value={checkOutDate} onChange={(e)=> setCheckOutDate(e.target.value)} id="" />
